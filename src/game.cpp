...
void Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen){
    ...
    if(SDL_Init(SDL_INIT_EVERYTHING) == 0){
        ...
        snake1 = new Snake("assets/head1.png", "assets/body1.png", "assets/tail1.png", "assets/head-white.png", "assets/body-white.png", "assets/tail-white.png", BOARD_WIDTH/2-1, BOARD_HEIGHT/3, new Direction(Direction::DOWN), 0, gameBoard);
        gameObjects.push_back(snake1);

        snake2 = new Snake("assets/head2.png", "assets/body2.png", "assets/tail2.png", "assets/head-white.png", "assets/body-white.png", "assets/tail-white.png", BOARD_WIDTH/2, BOARD_HEIGHT/3, new Direction(Direction::DOWN), 0, gameBoard);
